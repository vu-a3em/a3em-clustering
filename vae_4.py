...
class Encoder(torch.nn.Module):
    def __init__(self, *, embedding_size):
        ...
        self.convolutions = torch.nn.ModuleList([
            torch.nn.Conv2d(1, 128, kernel_size = (4, 4), stride = 2),
            torch.nn.Conv2d(128, 256, kernel_size = (2, 2), stride = 2),
            torch.nn.Conv2d(256, 128, kernel_size = (2, 2), stride = 2),
            torch.nn.Conv2d(128, 128, kernel_size = (2, 2), stride = 2),
            torch.nn.Conv2d(128, 64, kernel_size = (2, 2), stride = 2),
        ])
...
class Decoder(torch.nn.Module):
    def __init__(self, *, embedding_size):
        ...
        self.convolutions = torch.nn.ModuleList([
            torch.nn.ConvTranspose2d(64, 128, kernel_size = (2, 2), stride = 2, output_padding = (1, 1)),
            torch.nn.Conv2d(128, 128, kernel_size = (7, 7), padding = 3, groups = 128, padding_mode = PADDING_MODE),
            torch.nn.Conv2d(128, 128, kernel_size = (5, 5), padding = 2, groups = 128, padding_mode = PADDING_MODE),
            torch.nn.Conv2d(128, 128, kernel_size = (3, 3), padding = 1, groups = 128, padding_mode = PADDING_MODE),

            torch.nn.ConvTranspose2d(128, 128, kernel_size = (2, 2), stride = 2, output_padding = (1, 0)),
            torch.nn.Conv2d(128, 128, kernel_size = (7, 7), padding = 3, groups = 128, padding_mode = PADDING_MODE),
            torch.nn.Conv2d(128, 128, kernel_size = (5, 5), padding = 2, groups = 128, padding_mode = PADDING_MODE),
            torch.nn.Conv2d(128, 128, kernel_size = (3, 3), padding = 1, groups = 128, padding_mode = PADDING_MODE),

            torch.nn.ConvTranspose2d(128, 256, kernel_size = (2, 2), stride = 2, output_padding = (1, 1)),
            torch.nn.Conv2d(256, 256, kernel_size = (7, 7), padding = 3, groups = 256, padding_mode = PADDING_MODE),
            torch.nn.Conv2d(256, 256, kernel_size = (5, 5), padding = 2, groups = 256, padding_mode = PADDING_MODE),
            torch.nn.Conv2d(256, 256, kernel_size = (3, 3), padding = 1, groups = 256, padding_mode = PADDING_MODE),

            torch.nn.ConvTranspose2d(256, 128, kernel_size = (2, 2), stride = 2, output_padding = (1, 1)),
            torch.nn.Conv2d(128, 128, kernel_size = (7, 7), padding = 3, groups = 128, padding_mode = PADDING_MODE),
            torch.nn.Conv2d(128, 128, kernel_size = (5, 5), padding = 2, groups = 128, padding_mode = PADDING_MODE),
            torch.nn.Conv2d(128, 128, kernel_size = (3, 3), padding = 1, groups = 128, padding_mode = PADDING_MODE),

            torch.nn.ConvTranspose2d(128, 1, kernel_size = (4, 4), stride = 2, output_padding = (1, 1)),
            torch.nn.Conv2d(1, 1, kernel_size = (7, 7), padding = 3, groups = 1, padding_mode = PADDING_MODE),
            torch.nn.Conv2d(1, 1, kernel_size = (5, 5), padding = 2, groups = 1, padding_mode = PADDING_MODE),
            torch.nn.Conv2d(1, 1, kernel_size = (3, 3), padding = 1, groups = 1, padding_mode = PADDING_MODE),
        ])
    def forward(self, x):
